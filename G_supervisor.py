...
from G_pandas_agent import PandasAgent
...
class TyphoonAgent:
    def __init__(self, temperature: float, base_url: str, model_name: str):
        ...
        self.pandas_agent = PandasAgent(temperature, base_url, model_name)
    ...
    def initialize_tools(self):
        ...
        pandas_tool = Tool(
            ...
            description="Consult the PandasAgent to analyze and visualize data in a DataFrame.",
        )
        return [pandas_tool]

    def query_dataframe(self, user_input: str) -> str:
        """
